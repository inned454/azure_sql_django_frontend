...
const api = axios.create({
  baseURL: 'https://inn-backend-ajdne2and6b9cugc.southeastasia-01.azurewebsites.net/api',
...
const FUNCTION_API_URL = 'https://inn-content-filter-cregh2e0dwagerdv.southeastasia-01.azurewebsites.net/api';
